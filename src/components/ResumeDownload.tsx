...
const ResumeDownload = () => {
  ...
  return (
    <div>
      <ActionButton onClick={downloadResume} text="Download CV" />
      {error && (
        <Alert
      ...
      {loading && (
        <Box
          sx={{ display: "flex", marginTop: "5px", justifyContent: "center" }}
        >
          <CircularProgress size={24} sx={{ color: COLORS.progress }} />
        </Box>
      )}
